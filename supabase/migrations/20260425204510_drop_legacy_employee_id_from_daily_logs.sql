drop function if exists public.upsert_daily_log_with_employees(
  uuid,
  date,
  text,
  text,
...
drop index if exists daily_log_employees_log_user_id_key;
drop index if exists daily_log_employees_user_id_idx;
