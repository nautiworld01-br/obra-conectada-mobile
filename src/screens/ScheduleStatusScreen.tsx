    ...
    <View style={styles.screen}>
      ...
      {isLoading ? (
        <View style={styles.emptyState}>
          <Text style={styles.emptyText}>Carregando etapas...</Text>
        </View>
      ) : filteredStages.length === 0 ? (
        <View style={styles.emptyState}>
          <Text style={styles.emptyText}>Nenhuma etapa com esse status.</Text>
        </View>
      ) : (
              ...
              >
                <View style={styles.stageHeader}>
                  ...
                  <View style={[styles.stageStatusPill, { backgroundColor: statusColors.pillBackground }]}>
                    <Text style={[styles.stageStatusText, { color: statusColors.pillText }]}>{statusLabels[stage.status]}</Text>
                  </View>
                </View>
